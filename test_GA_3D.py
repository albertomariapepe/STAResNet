...
model.load_weights('models/GA_ResNet_final3D_5s_28.h5')
print(testdata_path)
            ...
            for k in range(0, 9, 3):
                ...
                while k < m:
                    ...
                    if m == 10 and count < 10 and j == 3:
                        ...
                        plt.show()
                        plt.savefig('plots/GA_F' + str(m) + str(k) + '.png', bbox_inches='tight')
                        ...
                        ax.scatter(X, Y, Z, c = colors, s = 150)
                        plt.show()
                        plt.savefig('plots/GA_Fdiff' + str(m) + str(k) + '.png', bbox_inches='tight')
            ...
            for k in range(0, 9, 3):
                ...
                while k < m:
                    ...
                    if m == 10 and count < 10 and j == 3:
                        ...
                        plt.savefig('plots/GA_F_z0_' + str(m) + str(k) + '.png')
                        ...
                        plt.figure()
                        cc = plt.imshow(Fmag, cmap='Spectral', interpolation = 'bilinear')  # You can change the colormap as needed
                        plt.savefig('plots/GA_F_z13_' + str(m) + str(k) + '.png')
                        ...
                        plt.figure()
                        cc = plt.imshow(Fmag, cmap='Spectral', interpolation = 'bilinear')  # You can change the colormap as needed
                        plt.savefig('plots/GA_F_z27_' + str(m) + str(k) + '.png')
                        ...
                        cc = plt.imshow(abs(Fmag_z0 - Fmag_pred_z0), cmap='viridis',  interpolation = 'bilinear', vmin = 0, vmax = 0.0005)  # You can change the colormap as needed
                        plt.savefig('plots/GA_Fdiff_z0_' + str(m) + str(k) + '.png')

                        cc = plt.imshow(abs(Fmag_z13 - Fmag_pred_z13), cmap='viridis',  interpolation = 'bilinear', vmin = 0, vmax = 0.0005)  # You can change the colormap as needed
                        plt.savefig('plots/GA_Fdiff_z13_' + str(m) + str(k) + '.png')

                        cc = plt.imshow(abs(Fmag_z27 - Fmag_pred_z27), cmap='viridis',  interpolation = 'bilinear', vmin = 0, vmax = 0.0005)  # You can change the colormap as needed
                        plt.savefig('plots/GA_Fdiff_z27_' + str(m) + str(k) + '.png')
